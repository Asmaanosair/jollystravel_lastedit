                    ...
                    <div class="page-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form  method="post" action="{{url('/gs_admin/up_about/'.$pro->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber" id="editor11"  name="o_des_en" data-a-sign="Name">{{$pro->o_des_en}}</textarea>
                                            @if ($errors->has('o_des_en'))
                                                <span class="help-block">
                                            <strong>{{ $errors->first('o_des_en') }}</strong>
                                        </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber"  id="editor12" name="o_des_de" data-a-sign="Name">{{$pro->o_des_de}}</textarea>
                                            @if ($errors->has('o_des_de'))
                                                <span class="help-block">
                                            <strong>{{ $errors->first('o_des_de') }}</strong>
                                        </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber" id="editor13"  name="o_des_it" data-a-sign="Name">{{$pro->o_des_it}}</textarea>
                                            @if ($errors->has('o_des_it'))
                                                <span class="help-block">
                                            <strong>{{ $errors->first('o_des_it') }}</strong>
                                        </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber" id="editor14" name="o_des_es" data-a-sign="Name">{{$pro->o_des_es}}</textarea>
                                            @if ($errors->has('o_des_es'))
                                                <span class="help-block">
                                            <strong>{{ $errors->first('o_des_es') }}</strong>
                                        </span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber" name="o_des_fr"   id="editor15"  data-a-sign="Name">{{$pro->o_des_fr}}</textarea>
                                            @if ($errors->has('o_des_fr'))
                                                <span class="help-block">
                                            <strong>{{ $errors->first('o_des_fr') }}</strong>
                                        </span>
                                            @endif
                                        </div>
                                    </div>
