                    ...
                    <div class="page-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form  method="post" action="{{url('/gs_admin/up_detail/'.$pro->id)}}" enctype="multipart/form-data">
...
<a  href="{{url('/gs_admin/detail/'.$pro->id)}}"class="btn btn-success">back to Details</a>
    </div>
    </div>
