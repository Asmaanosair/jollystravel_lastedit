                    ...
                    <div class="page-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form  method="post" action="{{url('/gs_admin/up_hotel/'.$pro->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" name="n_room" value="{{$pro->n_room}}"  data-a-sign="Name">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" name="n_cust" value="{{$pro->n_cust}}"  data-a-sign="Name">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" name="n_rest" value="{{$pro->n_rest}}"  data-a-sign="Name">
                                       ...
                                       <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" name="loc" value="{{$pro->loc}}"  data-a-sign="Name">
                                            @if ($errors->has('loc'))
                                                <span class="help-block">
