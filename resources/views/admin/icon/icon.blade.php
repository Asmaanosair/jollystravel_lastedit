                ...
                <div class="page-header">
                    ...
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#">Font Awesome</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="card-block">
                                    <div class="data-table-main icon-list-demo">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-zip-o"></i>
                                                <label class="txt-ellipsis"> fa-file-zip-o <span class="text-muted">(alias)</span></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="data-table-main icon-list-demo">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-center"></i>
                                                <label class="txt-ellipsis"> fa-align-center</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-justify"></i>
                                                <label class="txt-ellipsis"> fa-align-justify</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-left"></i>
                                                <label class="txt-ellipsis"> fa-align-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-right"></i>
                                                <label class="txt-ellipsis"> fa-align-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bold"></i>
                                                <label class="txt-ellipsis"> fa-bold</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chain"></i>
                                                <label class="txt-ellipsis"> fa-chain <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chain-broken"></i>
                                                <label class="txt-ellipsis"> fa-chain-broken</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-clipboard"></i>
                                                <label class="txt-ellipsis"> fa-clipboard</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-columns"></i>
                                                <label class="txt-ellipsis"> fa-columns</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-copy"></i>
                                                <label class="txt-ellipsis"> fa-copy <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-cut"></i>
                                                <label class="txt-ellipsis"> fa-cut <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-dedent"></i>
                                                <label class="txt-ellipsis"> fa-dedent <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-eraser"></i>
                                                <label class="txt-ellipsis"> fa-eraser</label>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-files-o"></i>
                                                <label class="txt-ellipsis"> fa-files-o</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-floppy-o"></i>
                                                <label class="txt-ellipsis"> fa-floppy-o</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-font"></i>
                                                <label class="txt-ellipsis"> fa-font</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-header"></i>
                                                <label class="txt-ellipsis"> fa-header</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-indent"></i>
                                                <label class="txt-ellipsis"> fa-indent</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-italic"></i>
                                                <label class="txt-ellipsis"> fa-italic</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-link"></i>
                                                <label class="txt-ellipsis"> fa-link</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list"></i>
                                                <label class="txt-ellipsis"> fa-list</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list-alt"></i>
                                                <label class="txt-ellipsis"> fa-list-alt</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list-ol"></i>
                                                <label class="txt-ellipsis"> fa-list-ol</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list-ul"></i>
                                                <label class="txt-ellipsis"> fa-list-ul</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-outdent"></i>
                                                <label class="txt-ellipsis"> fa-outdent</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-paperclip"></i>
                                                <label class="txt-ellipsis"> fa-paperclip</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-paragraph"></i>
                                                <label class="txt-ellipsis"> fa-paragraph</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-paste"></i>
                                                <label class="txt-ellipsis"> fa-paste <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-repeat"></i>
                                                <label class="txt-ellipsis"> fa-repeat</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rotate-left"></i>
                                                <label class="txt-ellipsis"> fa-rotate-left <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rotate-right"></i>
                                                <label class="txt-ellipsis"> fa-rotate-right <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-save"></i>
                                                <label class="txt-ellipsis"> fa-save <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-scissors"></i>
                                                <label class="txt-ellipsis"> fa-scissors</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-strikethrough"></i>
                                                <label class="txt-ellipsis"> fa-strikethrough</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-subscript"></i>
                                                <label class="txt-ellipsis"> fa-subscript</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-superscript"></i>
                                                <label class="txt-ellipsis"> fa-superscript</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-table"></i>
                                                <label class="txt-ellipsis"> fa-table</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-text-height"></i>
                                                <label class="txt-ellipsis"> fa-text-height</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-text-width"></i>
                                                <label class="txt-ellipsis"> fa-text-width</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-th"></i>
                                                <label class="txt-ellipsis"> fa-th</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-th-large"></i>
                                                <label class="txt-ellipsis"> fa-th-large</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-th-list"></i>
                                                <label class="txt-ellipsis"> fa-th-list</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-underline"></i>
                                                <label class="txt-ellipsis"> fa-underline</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-undo"></i>
                                                <label class="txt-ellipsis"> fa-undo</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-unlink"></i>
                                                <label class="txt-ellipsis"> fa-unlink <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Text Editor Icons end -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <!-- Directional Icons start -->
                            <div class="card">
                                <div class="card-header">
                                ...
                                <div class="card-block">
                                    <div class="data-table-main icon-list-demo">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-down"></i>
                                                <label class="txt-ellipsis"> fa-angle-double-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-left"></i>
                                                <label class="txt-ellipsis"> fa-angle-double-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-right"></i>
                                                <label class="txt-ellipsis"> fa-angle-double-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-up"></i>
                                                <label class="txt-ellipsis"> fa-angle-double-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-down"></i>
                                                <label class="txt-ellipsis"> fa-angle-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-left"></i>
                                                <label class="txt-ellipsis"> fa-angle-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-right"></i>
                                                <label class="txt-ellipsis"> fa-angle-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-up"></i>
                                                <label class="txt-ellipsis"> fa-angle-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-down"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-left"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-down"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-o-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-left"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-o-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-right"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-o-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-up"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-o-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-right"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-up"></i>
                                                <label class="txt-ellipsis"> fa-arrow-circle-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-down"></i>
                                                <label class="txt-ellipsis"> fa-arrow-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-left"></i>
                                                <label class="txt-ellipsis"> fa-arrow-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-right"></i>
                                                <label class="txt-ellipsis"> fa-arrow-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-up"></i>
                                                <label class="txt-ellipsis"> fa-arrow-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows"></i>
                                                <label class="txt-ellipsis"> fa-arrows</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows-alt"></i>
                                                <label class="txt-ellipsis"> fa-arrows-alt</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows-h"></i>
                                                <label class="txt-ellipsis"> fa-arrows-h</label>
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-down"></i>
                                                <label class="txt-ellipsis"> fa-caret-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-left"></i>
                                                <label class="txt-ellipsis"> fa-caret-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-right"></i>
                                                <label class="txt-ellipsis"> fa-caret-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-up"></i>
                                                <label class="txt-ellipsis"> fa-caret-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-square-o-left"></i>
                                                <label class="txt-ellipsis"> fa-caret-square-o-left</label>
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-down"></i>
                                                <label class="txt-ellipsis"> fa-chevron-circle-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-left"></i>
                                                <label class="txt-ellipsis"> fa-chevron-circle-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-right"></i>
                                                <label class="txt-ellipsis"> fa-chevron-circle-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-up"></i>
                                                <label class="txt-ellipsis"> fa-chevron-circle-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-down"></i>
                                                <label class="txt-ellipsis"> fa-chevron-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-left"></i>
                                                <label class="txt-ellipsis"> fa-chevron-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-right"></i>
                                                <label class="txt-ellipsis"> fa-chevron-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-up"></i>
                                                <label class="txt-ellipsis"> fa-chevron-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-down"></i>
                                                <label class="txt-ellipsis"> fa-hand-o-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-left"></i>
                                                <label class="txt-ellipsis"> fa-hand-o-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-right"></i>
                                                <label class="txt-ellipsis"> fa-hand-o-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-up"></i>
                                                <label class="txt-ellipsis"> fa-hand-o-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-down"></i>
                                                <label class="txt-ellipsis"> fa-long-arrow-down</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-left"></i>
                                                <label class="txt-ellipsis"> fa-long-arrow-left</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-right"></i>
                                                <label class="txt-ellipsis"> fa-long-arrow-right</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-up"></i>
                                                <label class="txt-ellipsis"> fa-long-arrow-up</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-toggle-down"></i>
                                                <label class="txt-ellipsis"> fa-toggle-down <span class="text-muted">(alias)</span>
                                                    </span>
                            ...
                            <!-- Directional Icons end -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <!-- Video Player Icons start -->
                            <div class="card">
                                <div class="card-header">
                                ...
                                <div class="card-block">
                                    <div class="data-table-main icon-list-demo">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-backward"></i>
                                                <label class="txt-ellipsis"> fa-backward</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-compress"></i>
                                                <label class="txt-ellipsis"> fa-compress</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-eject"></i>
                                                <label class="txt-ellipsis"> fa-eject</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-expand"></i>
                                                <label class="txt-ellipsis"> fa-expand</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-fast-backward"></i>
                                                <label class="txt-ellipsis"> fa-fast-backward</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-fast-forward"></i>
                                                <label class="txt-ellipsis"> fa-fast-forward</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-forward"></i>
                                                <label class="txt-ellipsis"> fa-forward</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pause"></i>
                                                <label class="txt-ellipsis"> fa-pause</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-play"></i>
                                                <label class="txt-ellipsis"> fa-play</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-play-circle"></i>
                                                <label class="txt-ellipsis"> fa-play-circle</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-play-circle-o"></i>
                                                <label class="txt-ellipsis"> fa-play-circle-o</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-step-backward"></i>
                                                <label class="txt-ellipsis"> fa-step-backward</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-step-forward"></i>
                                                <label class="txt-ellipsis"> fa-step-forward</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stop"></i>
                                                <label class="txt-ellipsis"> fa-stop</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube-play"></i>
                                                <label class="txt-ellipsis"> fa-youtube-play</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!-- Video Player Icons end -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Brand Icons</h5>
                                    <span>All brand icons are trademarks of their respective owners.
                                        The use of these trademarks does not indicate endorsement of the trademark holder by Font Awesome, nor vice versa.</span>
                                    <div class="card-header-right">
                                        <i class="icofont icofont-rounded-down"></i>
                                        <i class="icofont icofont-refresh"></i>
                                        <i class="icofont icofont-close-circled"></i>
                                ...
                                <div class="card-block">
                                    <div class="data-table-main icon-list-demo">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-adn"></i>
                                                <label class="txt-ellipsis"> fa-adn</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-android"></i>
                                                <label class="txt-ellipsis"> fa-android</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-apple"></i>
                                                <label class="txt-ellipsis"> fa-apple</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-behance"></i>
                                                <label class="txt-ellipsis"> fa-behance</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-behance-square"></i>
                                                <label class="txt-ellipsis"> fa-behance-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bitbucket"></i>
                                                <label class="txt-ellipsis"> fa-bitbucket</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bitbucket-square"></i>
                                                <label class="txt-ellipsis"> fa-bitbucket-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bitcoin"></i>
                                                <label class="txt-ellipsis"> fa-bitcoin <span class="text-muted">(alias)</span>
                                                    </span>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-codepen"></i>
                                                <label class="txt-ellipsis"> fa-codepen</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-css3"></i>
                                                <label class="txt-ellipsis"> fa-css3</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-delicious"></i>
                                                <label class="txt-ellipsis"> fa-delicious</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-deviantart"></i>
                                                <label class="txt-ellipsis"> fa-deviantart</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-digg"></i>
                                                <label class="txt-ellipsis"> fa-digg</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-dribbble"></i>
                                                <label class="txt-ellipsis"> fa-dribbble</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-dropbox"></i>
                                                <label class="txt-ellipsis"> fa-dropbox</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-drupal"></i>
                                                <label class="txt-ellipsis"> fa-drupal</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-empire"></i>
                                                <label class="txt-ellipsis"> fa-empire</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-facebook"></i>
                                                <label class="txt-ellipsis"> fa-facebook</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-facebook-square"></i>
                                                <label class="txt-ellipsis"> fa-facebook-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-flickr"></i>
                                                <label class="txt-ellipsis"> fa-flickr</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-foursquare"></i>
                                                <label class="txt-ellipsis"> fa-foursquare</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-ge"></i>
                                                <label class="txt-ellipsis"> fa-ge <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-git"></i>
                                                <label class="txt-ellipsis"> fa-git</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-git-square"></i>
                                                <label class="txt-ellipsis"> fa-git-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-github"></i>
                                                <label class="txt-ellipsis"> fa-github</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-github-alt"></i>
                                                <label class="txt-ellipsis"> fa-github-alt</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-github-square"></i>
                                                <label class="txt-ellipsis"> fa-github-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-gittip"></i>
                                                <label class="txt-ellipsis"> fa-gittip</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-google"></i>
                                                <label class="txt-ellipsis"> fa-google</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-google-plus"></i>
                                                <label class="txt-ellipsis"> fa-google-plus</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-google-plus-square"></i>
                                                <label class="txt-ellipsis"> fa-google-plus-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hacker-news"></i>
                                                <label class="txt-ellipsis"> fa-hacker-news</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-html5"></i>
                                                <label class="txt-ellipsis"> fa-html5</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-instagram"></i>
                                                <label class="txt-ellipsis"> fa-instagram</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-joomla"></i>
                                                <label class="txt-ellipsis"> fa-joomla</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-jsfiddle"></i>
                                                <label class="txt-ellipsis"> fa-jsfiddle</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-linkedin"></i>
                                                <label class="txt-ellipsis"> fa-linkedin</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-linkedin-square"></i>
                                                <label class="txt-ellipsis"> fa-linkedin-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-linux"></i>
                                                <label class="txt-ellipsis"> fa-linux</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-maxcdn"></i>
                                                <label class="txt-ellipsis"> fa-maxcdn</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-openid"></i>
                                                <label class="txt-ellipsis"> fa-openid</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pagelines"></i>
                                                <label class="txt-ellipsis"> fa-pagelines</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pied-piper"></i>
                                                <label class="txt-ellipsis"> fa-pied-piper</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pied-piper-alt"></i>
                                                <label class="txt-ellipsis"> fa-pied-piper-alt</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pinterest"></i>
                                                <label class="txt-ellipsis"> fa-pinterest</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pinterest-square"></i>
                                                <label class="txt-ellipsis"> fa-pinterest-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-qq"></i>
                                                <label class="txt-ellipsis"> fa-qq</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-ra"></i>
                                                <label class="txt-ellipsis"> fa-ra <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rebel"></i>
                                                <label class="txt-ellipsis"> fa-rebel</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-reddit"></i>
                                                <label class="txt-ellipsis"> fa-reddit</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-reddit-square"></i>
                                                <label class="txt-ellipsis"> fa-reddit-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-renren"></i>
                                                <label class="txt-ellipsis"> fa-renren</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-share-alt"></i>
                                                <label class="txt-ellipsis"> fa-share-alt</label>
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-skype"></i>
                                                <label class="txt-ellipsis"> fa-skype</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-slack"></i>
                                                <label class="txt-ellipsis"> fa-slack</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-soundcloud"></i>
                                                <label class="txt-ellipsis"> fa-soundcloud</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-spotify"></i>
                                                <label class="txt-ellipsis"> fa-spotify</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stack-exchange"></i>
                                                <label class="txt-ellipsis"> fa-stack-exchange</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stack-overflow"></i>
                                                <label class="txt-ellipsis"> fa-stack-overflow</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-steam"></i>
                                                <label class="txt-ellipsis"> fa-steam</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-steam-square"></i>
                                                <label class="txt-ellipsis"> fa-steam-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stumbleupon"></i>
                                                <label class="txt-ellipsis"> fa-stumbleupon</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stumbleupon-circle"></i>
                                                <label class="txt-ellipsis"> fa-stumbleupon-circle</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-tencent-weibo"></i>
                                                <label class="txt-ellipsis"> fa-tencent-weibo</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-trello"></i>
                                                <label class="txt-ellipsis"> fa-trello</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-tumblr"></i>
                                                <label class="txt-ellipsis"> fa-tumblr</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-tumblr-square"></i>
                                                <label class="txt-ellipsis"> fa-tumblr-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-twitter"></i>
                                                <label class="txt-ellipsis"> fa-twitter</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-twitter-square"></i>
                                                <label class="txt-ellipsis"> fa-twitter-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-vimeo-square"></i>
                                                <label class="txt-ellipsis"> fa-vimeo-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-vine"></i>
                                                <label class="txt-ellipsis"> fa-vine</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-vk"></i>
                                                <label class="txt-ellipsis"> fa-vk</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-wechat"></i>
                                                <label class="txt-ellipsis"> fa-wechat <span class="text-muted">(alias)</span>
                                                    </span>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-weibo"></i>
                                                <label class="txt-ellipsis"> fa-weibo</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-weixin"></i>
                                                <label class="txt-ellipsis"> fa-weixin</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-windows"></i>
                                                <label class="txt-ellipsis"> fa-windows</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-wordpress"></i>
                                                <label class="txt-ellipsis"> fa-wordpress</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-xing"></i>
                                                <label class="txt-ellipsis"> fa-xing</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-xing-square"></i>
                                                <label class="txt-ellipsis"> fa-xing-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-yahoo"></i>
                                                <label class="txt-ellipsis"> fa-yahoo</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube"></i>
                                                <label class="txt-ellipsis"> fa-youtube</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube-play"></i>
                                                <label class="txt-ellipsis"> fa-youtube-play</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube-square"></i>
                                                <label class="txt-ellipsis"> fa-youtube-square</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="data-table-main icon-list-demo">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-ambulance"></i>
                                                <label class="txt-ellipsis"> ambulance</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-h-square"></i>
                                                <label class="txt-ellipsis"> h-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-heart"></i>
                                                <label class="txt-ellipsis"> heart</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-heart-o"></i>
                                                <label class="txt-ellipsis">heart-o</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-heartbeat"></i>
                                                <label class="txt-ellipsis"> heartbeat</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hospital-o"></i>
                                                <label class="txt-ellipsis"> hospital-o</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-medkit"></i>
                                                <label class="txt-ellipsis"> medkit</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-plus-square"></i>
                                                <label class="txt-ellipsis"> plus-square</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stethoscope"></i>
                                                <label class="txt-ellipsis"> stethoscope</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-user-md"></i>
                                                <label class="txt-ellipsis"> user-md</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-wheelchair"></i>
                                                <label class="txt-ellipsis"> wheelchair</label>
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><i class="fa fa-wheelchair-alt"></i>
                                                <label class="txt-ellipsis">wheelchair-alt</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel">Font Awesome</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <strong>{{ $errors->first('code') }}</strong>
                                                ...
                                                <div class="form-group">
                                                 <button  class="form-control btn-success" type="submit">Add icon</button>
                                                </div>
