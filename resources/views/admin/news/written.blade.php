                        ...
                        <div class="modal fade" id="large-Modal" tabindex="-1" role="dialog">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form  method="post" action="{{url('/gs_admin/add_written')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-block tab-icon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-xl-12 tab-with-img">
                                                    ...
                                                    <form  method="post" action="{{url('/gs_admin/up_written/'.$row->id)}}" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                            ...
                                            <strong>{{ $errors->first('name_de') }}</strong>
                                                    ...
                                                    <a  href="{{url('/gs_admin/del_written/'.$row->id)}}" class="btn btn-danger" style="   margin-left: 50%; border-radius: 20px; font-size: 13px; color: #ffffff;">Delete</a>
