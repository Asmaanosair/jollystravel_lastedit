            ...
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    ...
                    <div class="page-body">
                        ...
                        <button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#large-Modal" style="margin: 10px">Add New Program</button>
                        <div class="modal fade" id="large-Modal" tabindex="-1" role="dialog">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form  method="post" action="{{url('/gs_admin/add_admin_program')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-block tab-icon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-xl-12 tab-with-img">
                                                    ...
                                                    <form  method="post" action="{{url('/gs_admin/up_admin_program/'.$row->id)}}" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                            ...
                                            <strong>{{ $errors->first('name_de') }}</strong>
                                                    ...
                                                    <a  href="{{url('/gs_admin/del_admin_program/'.$row->id)}}" class="btn btn-danger" style="   margin-left: 50%; border-radius: 20px; font-size: 13px; color: #ffffff;">Delete</a>
