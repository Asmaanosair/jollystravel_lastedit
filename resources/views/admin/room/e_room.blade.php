                    ...
                    <div class="page-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form  method="post" action="{{url('/gs_admin/up_room/'.$pro->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber"   name="des_en" data-a-sign="Name">{{$pro->des_en}}</textarea>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber"  name="des_de" data-a-sign="Name">{{$pro->des_de}}</textarea>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber"  name="des_it" data-a-sign="Name">{{$pro->des_it}}</textarea>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber"  name="des_es" data-a-sign="Name">{{$pro->des_es}}</textarea>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control autonumber"  name="des_fr" data-a-sign="Name">{{$pro->des_fr}}</textarea>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber"  name="max" value="{{$pro->max_guest}}" data-a-sign="Name">
                                            @if ($errors->has('max'))
                                                <span class="help-block">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" class="form-control autonumber"  name="hotel" data-a-sign="Name">
                                                @php(
                                                $prog2=App\hotel::find($pro->hotel_id)
                                                )
