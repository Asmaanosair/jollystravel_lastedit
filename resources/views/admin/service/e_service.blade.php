...
@section('content')
                    ...
                    <div class="page-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form  method="post" action="{{url('/gs_admin/up_service/'.$pro->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" value="{{$pro->room_en}}" name="room_en" data-a-sign="Name">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" value="{{$pro->room_de}}" name="room_de" data-a-sign="Name">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" value="{{$pro->room_it}}" name="room_it" data-a-sign="Name">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" value="{{$pro->room_es}}" name="room_es" data-a-sign="Name">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber" name="room_fr" value="{{$pro->room_fr}}"  data-a-sign="Name">
    ...
    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control autonumber"  value="{{$pro->guest}}" name="guest" data-a-sign="Name">
                                            @if ($errors->has('guest'))
                                                <span class="help-block">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" class="form-control autonumber"  name="prog" data-a-sign="Name">
                                                @php(
                                                $prog2=App\sub_program::find($pro->sub_program_id)
                                                )
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select type="text" class="form-control autonumber"  name="admin" data-a-sign="Name">
                                                @php(
                                                $admin2=App\User::find($pro->user_id)
                                                )
                                                <option value="{{$admin2->id}}">{{$admin2->name}}</option>
