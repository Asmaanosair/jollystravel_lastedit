            ...
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    ...
                    <div class="page-body">
                        ...
                        <button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#large-Modal" style="margin: 10px">Add New Testimonial</button>
                        <div class="modal fade" id="large-Modal" tabindex="-1" role="dialog">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form  method="post" action="{{url('/gs_admin/add_test')}}" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label"> Testimonial_DE</label>
                                                </div>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label">Testimonial_IT</label>
                                                </div>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label">Testimonial_ES</label>
                                                </div>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label">Testimonial_FR</label>
                                                </div>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="card-block tab-icon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-xl-12 tab-with-img">
                                                    ...
                                                    <form  method="post" action="{{url('/gs_admin/up_test/'.$row->id)}}" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                            ...
                                            <strong>{{ $errors->first('s_des_it') }}</strong>
                                                    ...
                                                    <a  href="{{url('/gs_admin/del_test/'.$row->id)}}" class="btn btn-danger" style="   margin-left: 50%; border-radius: 20px; font-size: 13px; color: #ffffff;">Delete</a>
