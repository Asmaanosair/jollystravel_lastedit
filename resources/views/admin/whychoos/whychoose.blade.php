...
@section('content')
                        ...
                        <div class="modal fade" id="large-Modal" tabindex="-1" role="dialog">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <form  method="post" action="{{url('/gs_admin/add_why')}}" enctype="multipart/form-data">
 ...
 <input type="text" class="form-control autonumber"  name="icon" data-a-sign="Name">
                                        ...
                                        <div class="card-block tab-icon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-xl-12 tab-with-img">
                                                    ...
                                                    <form  method="post" action="{{url('/gs_admin/up_why/'.$row->id)}}" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                            ...
                                            <strong>{{ $errors->first('s_des_it') }}</strong>
                                                                        ...
                                                                        <div class="row form-group">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                <input type="text" class="form-control autonumber"  value="{{$row->icon}}" name="icon" data-a-sign="Name">
                                                                               {!!$row->icon!!}
                                                                                @if ($errors->has('icon'))
                                                                                    <span class="help-block">
                                            <strong>{{ $errors->first('icon') }}</strong>
                                                    ...
                                                    <a  href="{{url('/gs_admin/del_why/'.$row->id)}}" class="btn btn-danger" style="   margin-left: 50%; border-radius: 20px; font-size: 13px; color: #ffffff;">Delete</a>
