    ...
    <div id="wrapper">
        ...
        <div class="content">
            ...
            <section class="parallax-section single-par" data-scrollax-parent="true">
                @if($service_id->img==null)
                <div class="bg par-elem "  data-bg="{{asset('website/assets/images/bg/1.jpg')}}" data-scrollax="properties: { translateY: '30%' }"></div>
                @else
                 <div class="bg par-elem "  data-bg="{{asset('img/'.$service_id->img)}}" data-scrollax="properties: { translateY: '30%' }"></div>
                @endif
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <!--                        <select data-placeholder="City" name="prog" class="chosen-select" >-->
                            <!--                            <option>select your favorite tour </option>-->

                            <!--                            @if($sub==null)-->
                            <!--            @else-->
                            <!--                @foreach($sub as $val) <option> {{$val->name_en}}</option> @endforeach -->
                            <!--                @endif-->
