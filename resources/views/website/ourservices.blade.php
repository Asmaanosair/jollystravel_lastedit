    ...
    <div id="wrapper">
        ...
        <div class="content">
            ...
            <section class="parallax-section single-par" data-scrollax-parent="true">
                ...
                <div class="container">
                    <div class="section-title center-align big-title">
                        ...
                        <h2><span>{{$service_id->name_en}}</span></h2>
            ...
            <div class="breadcrumbs-fs fl-wrap">
                <div class="container">
                    <div class="breadcrumbs fl-wrap"><a href="#">Home</a><span>{{$service_id->name_en}}</span></div>
                </div>
            </div>
            <!--section -->
                                            ...
                                            <div class="col-list-search-input-item in-loc-dec fl-wrap not-vis-arrow">
                                                ...
                                                <div class="listsearch-input-item">
                                                    <select data-placeholder="City" class="chosen-select" >
                                                       ...
                                                       @foreach($ser as $row) <option> {{$row->name_en}}</option> @endforeach
                                                ...
                                                <div class="listing-item">
                                                    <article class="geodir-category-listing fl-wrap">
                                                        <div class="geodir-category-img">
                                                            <a href="listing-single.html"><img src="{{asset('img/'.$val->m_img)}}" alt=""></a>
                                                            <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('img/'.$val->m_img)}}" alt=""></a>
                                                                <span class="avatar-tooltip">Added By  <strong>Alisa Noory</strong></span>
                                                            </div>
                                                            @if ($row->sale==null) @else <div class="sale-window">Sale {{$val->sale}}%</div> @endif
                                                        ...
                                                        <div class="geodir-category-content fl-wrap title-sin_item">
                                                            <div class="geodir-category-content-title fl-wrap">
                                                                <div class="geodir-category-content-title-item">
                                                                    <h3 class="title-sin_map"><a href="{{url('/Service/'.$val->name_en)}}">{{$val->name_en}}</a></h3>
                                                            ...
                                                            <div class="geodir-category-footer fl-wrap">
                                                                <div class="geodir-category-price">Awg/Price <span>$ {{$val->price}}</span></div>
                                                                <div class="geodir-opt-list">
                                                                    ...
                                                                    <a href="{{url('/Service/'.$val->name_en)}}" class="geodir-js-booking"><i class="fa fa-list"></i><span class="geodir-opt-tooltip">Show Details </span></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </article>
