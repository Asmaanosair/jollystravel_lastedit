    ...
    <div id="wrapper">
        ...
        <div class="content">
            ...
            <div class="breadcrumbs-fs fl-wrap">
                <div class="container">
                    <div class="breadcrumbs fl-wrap"><a href="#">Home</a><a href="#">  
                                     @php(
                                $sight=explode(',',$tran->sight)
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="post-container fl-wrap">
                                ...
                                <div class="article-masonry">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="{{url('/Place/'.$row->id.'/'.Config::get('app.locale'))}}"><img  src="{{asset('img/'.$row->m_img)}}"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="{{url('/Place/'.$row->id.'/'.Config::get('app.locale'))}}">{{$row->name_en}}.</a></h3>
                                            <p> {{$row->s_des_en}}. </p>
                                ...
                                $sight=explode(',',$tran->sight)
                                   ...
                                   @if(Config::get('app.locale') == 'en')
                                            ...
                                            <div class="search-widget">
                                                    ...
                                                    <form action="{{url('/place_search/'.Config::get('app.locale'))}}" method="get" id="search" class="fl-wrap"
                                                        {{csrf_field()}}

                                                        <input name="place" id="se" type="text" class="search" placeholder="Search.."  />
